        ...
        <div className="relative flex-1 max-w-7xl mx-auto px-6 sm:px-10 w-full grid lg:grid-cols-2 gap-8 pt-28">
          ...
          <motion.div className="relative flex items-end pb-0 lg:pb-0" style={{ minHeight: "70vh" }}>
            <motion.div style={{ scale: imgScale, opacity: imgOpacity }}
              ...
              <img src="/aboutmainphoto.png" alt="Vijay Bandaru"
          ...
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <a
                  href="/vijay-kumar-bandaru-resume.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-3 rounded-2xl text-sm font-bold text-slate-200 hover:text-white transition-all"
                  style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)" }}
                >
                  My Resume
                </a>
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
            {[
              ...
              const isHighlighted = d.letter === "C"
              return (
              <motion.div key={d.letter} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
                ...
                {d.body && <p className="text-white text-xs leading-relaxed">{d.body}</p>}
              </motion.div>
              )
            })}
          </div>
