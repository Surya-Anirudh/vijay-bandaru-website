...
const posts: Post[] = [
  ...
  {
    slug: "scrum-vs-safe",
    title: "Scrum Vs SAFe (Scaled Agile Framework)",
    category: "Scrum",
    readTime: "6 min read",
    date: "2024",
    excerpt: "Scrum and the Scaled Agile Framework (SAFe) are both Agile methods, but they serve different purposes and are suited for different scales of operation. Here are the key differences between Scrum and SAFe.",
    content: [
      { type: "p", text: "Scrum and the Scaled Agile Framework (SAFe) are both Agile methods, but they serve different purposes and are suited for different scales of operation. Here are the key differences between Scrum and SAFe:" },
      { type: "h3", text: "1. Scope and Scale" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: [
      ...
      { type: "h3", text: "3. Roles" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Roles are limited to Product Owner, Scrum Master, and Development Team members."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: ["Expands roles to include Product Manager, Release Train Engineer, Solution Train Engineer, System Architect/Engineer, Business Owners, and more."] },
      { type: "h3", text: "4. Planning and Cadence" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Planning is done at the sprint level (typically 2-4 weeks)."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: [
      ...
      { type: "h3", text: "5. Alignment and Governance" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Focuses on team autonomy with minimal prescribed alignment across teams."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: ["Emphasizes alignment and governance across the enterprise through the use of value streams, Lean Portfolio Management, and the alignment of teams to common goals and objectives."] },
      { type: "h3", text: "6. Backlogs and Work Items" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Uses Product Backlog and Sprint Backlog to manage work items."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: [
      ...
      { type: "h3", text: "7. Metrics and Reporting" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Uses basic metrics such as burndown charts, velocity, and sprint reports."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: ["Employs more comprehensive metrics and reporting mechanisms, including Program Predictability Measure, Solution Metrics, and Lean Portfolio Metrics."] },
      { type: "h3", text: "8. Implementation Complexity" },
      { type: "h3", text: "Scrum:" },
      { type: "ul", items: ["Easier and quicker to implement, suitable for small teams or projects."] },
      { type: "h3", text: "SAFe:" },
      { type: "ul", items: ["More complex and requires significant effort and coordination to implement, but is suitable for large-scale, enterprise-level Agile transformations."] },
      { type: "p", text: "In summary, Scrum is a lightweight framework ideal for small, self-contained Agile teams, whereas SAFe is a comprehensive framework designed to scale Agile practices across large organizations, providing additional roles, layers, and practices to manage complexity and alignment at scale." },
    ],
  },
  {
    slug: "automation-vs-ai-agent-vs-agentic-workflow",
    title: "Automation Vs AI Agent Vs Agentic Workflow",
    category: "AI",
    readTime: "5 min read",
    date: "2024",
    excerpt: "Today, the terms Automation, AI Agents, and Agentic Workflows are everywhere. While they sound similar, they serve different purposes and are best suited for different situations.",
    content: [
      { type: "p", text: "Today, the terms Automation, AI Agents, and Agentic Workflows are everywhere. While they sound similar, they serve different purposes and are best suited for different situations." },
      { type: "p", text: "Let's break them down with simple examples so you know when to use which." },
      { type: "h3", text: "1. Automation: Rule-Based Efficiency" },
      { type: "h3", text: "What it is:" },
      { type: "p", text: "Automation uses predefined rules and triggers to perform repetitive tasks. There's no \"intelligence\" — it does exactly what it's told, every time." },
      ...
      { type: "p", text: "Think of automation as your reliable assistant who follows a checklist perfectly — but never improvises." },
      { type: "h3", text: "2. AI Agent: Intelligent Problem-Solver" },
      { type: "h3", text: "What it is:" },
      { type: "p", text: "An AI Agent is autonomous software that uses AI to perceive, decide, and act towards a goal. Unlike automation, it can:" },
      { type: "ul", items: [
        "Understand context",
      ...
      { type: "p", text: "An AI Agent is like a smart colleague — they don't just follow the checklist; they can decide the best next step." },
      { type: "h3", text: "3. Agentic Workflow: Orchestration of Multiple Agents" },
      { type: "h3", text: "What it is:" },
      { type: "p", text: "Agentic workflows are systems where multiple AI agents (or agents + automations) collaborate toward a larger goal. Each agent specializes in part of the task, and the workflow orchestrates them." },
      { type: "h3", text: "Example:" },
      { type: "p", text: "Imagine your bike service app has an end-to-end service agentic workflow:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "All work together seamlessly to give the customer a smooth, intelligent experience." },
      { type: "h3", text: "Best suited for:" },
      { type: "ul", items: [
      ...
      { type: "p", text: "An agentic workflow is like a team of smart colleagues, each specializing in their domain, collaborating under a shared playbook." },
      { type: "h3", text: "When to Use Which?" },
      {
        type: "table",
        headers: ["Situation", "Best Fit", "Why"],
        rows: [
