          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 20, overflow: "hidden" }}>
              ...
              <div style={{ padding: "24px 32px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                {/* Illustration 1 */}
                <div style={{ borderRadius: 12, overflow: "hidden", marginBottom: 16, background: "#fff", textAlign: "center" }}>
                  <img src="/fish-glass-wall.png" alt="Big fish separated from small fishes by a glass wall" style={{ maxWidth: "100%", height: "auto", display: "inline-block" }} />
                </div>
                ...
                {/* Illustration 2 */}
                <div style={{ borderRadius: 12, overflow: "hidden", marginBottom: 16, background: "#fff", textAlign: "center" }}>
                  <img src="/fish-no-wall.png" alt="Big fish with small fishes freely swimming — no glass wall" style={{ maxWidth: "100%", height: "auto", display: "inline-block" }} />
                </div>
