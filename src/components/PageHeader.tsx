  ...
  return (
    <div className="relative pt-32 pb-24 px-4 overflow-hidden" style={{ background: "#030d1e" }}>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{
        ...
        backgroundSize: isPodcast ? "32px 32px" : "80px 80px",
      }} />

      {/* Podcast diagonal accent lines */}
      {isPodcast && <>
        <div className="absolute inset-0 pointer-events-none opacity-20" style={{
          backgroundImage: "repeating-linear-gradient(45deg, rgba(59,130,246,0.3) 0px, rgba(59,130,246,0.3) 1px, transparent 1px, transparent 60px)",
        }} />
      </>}
      ...
      {isPodcast && <div className="absolute top-10 right-10 w-48 h-48 rounded-full pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(96,165,250,0.2) 0%, transparent 70%)", filter: "blur(40px)", animation: "glow-pulse 6s ease-in-out infinite 1s" }} />}
